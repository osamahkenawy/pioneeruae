...
const speciaList = [
  {
    ...
    desp: "Enhance your vehicle's performance with our professional upgrade and customization services tailored to your requirements.",
  },
  {
    id: 2,
    img: "/assets/img/service/service_2.jpg",
    title: "Engine Diagnostics and Repair",
    desp: "Advanced computerised diagnostics for accurate fault detection, followed by expert engine repair services.",
  },
  {
    id: 3,
    img: "/assets/img/service/service_3.jpg",
    title: "Tire Services",
    desp: "Complete tyre change, replacement, and computerised wheel balancing and alignment services for optimal driving safety.",
  },
];
