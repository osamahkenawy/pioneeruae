...
const sliderData = [
  {
    id: 1,
    title: "THE BEST CAR REPAIR",
    maintitle: "WORKSHOPS IN UAE",
    desp: "Pioneer Car Service Center - one of the UAE's leading multi-brand workshops catering to corporate fleets and individual vehicles.",
    url: "/contact",
  ...
  },
  {
    ...
    title: "THE BEST CAR REPAIR",
    maintitle: "WORKSHOPS IN UAE",
    desp: "Delivering high quality products and services at competitive prices with branches in Sharjah, Dubai, Abu Dhabi and Al Ain.",
    url: "/contact",
    ...
    <section className="ak-slider ak-slider-hero-1">
      ...
      <div className="social-hero">
        <Link to="https://www.instagram.com/pioneercaremn/" className="social-icon1">
          <img src="/assets/img/icon/twiter.svg" alt="instagram" />
        </Link>
