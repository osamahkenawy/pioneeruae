          ...
          <div className="center-section-heading" data-aos="fade-up">
            <div className="ak-section-heading ak-style-1 ak-type-1">
              ...
              <p className="ak-section-subtitle">
                Explore our competitive service packages designed to keep your
                vehicle in peak condition. Quality care at transparent prices
                across all our UAE locations.
              </p>
            </div>
          </div>
