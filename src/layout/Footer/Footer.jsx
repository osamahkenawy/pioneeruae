...
import footerLogo from "/assets/img/pioneer_logo_white_colors.png";
...
const footerDataArray = [
  {
    ...
    dataAosDelay: "0",
    phone: "80077799",
    desp: "Pioneer Car Service Center Sole Proprietorship L.L.C is one of the UAE's multi-brand workshop catering to corporate fleets and individual vehicle and delivering high quality products and services at competitive prices.",
  },
  {
  ...
  },
  {
    ...
    dataAosDelay: "100",
    links: [
      { title: "Abu Dhabi", link: "/contact" },
      { title: "Dubai", link: "/contact" },
      { title: "Al Ain", link: "/contact" },
      { title: "Sharjah", link: "/contact" },
    ],
  },
  {
    className: "footer-address",
    dataAosDelay: "150",
    address: "Sharjah, Dubai, Abu Dhabi, Al Ain - UAE",
      ...
      <footer className="footer style-1 footer-bg">
        <div className="container">
          ...
          <div className="footer-logo">
            <img src={footerLogo} alt="footer-logo" style={{ maxWidth: '250px', height: 'auto' }} />
          ...
          <div className="copy-right">
            ...
            <div className="social-icon">
              <Link to="https://www.facebook.com/PioneerCare/">
                <img src="/assets/img/icon/facebookicon.svg" alt="Facebook" />
              </Link>
              <Link to="https://www.linkedin.com/company/pioneer-car-service-center/">
                <img src="/assets/img/icon/linkedinicon.svg" alt="LinkedIn" />
              </Link>
              <Link to="https://www.instagram.com/pioneercaremn/">
                <img src="/assets/img/icon/twittericon.svg" alt="Instagram" />
              </Link>
            </div>
          </div>
        </div>
